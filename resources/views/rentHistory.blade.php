                 ...
                 <div class="">
                    ...
                    <div class="trainer-item">
                        ...
                        <div class="">
                            ...
                            <h4>{{$item->rent_date}}</h4>
                            <h4>{{$item->status}}</h4>
                            <p>{{$item->quantity}} bikes</p>
                            <p>{{$item->rent_price}}dt</p>
                        ...
                        @if($item->status=='pending')
                            ...
                            <a href="/cancelOrder/{{$item->rent_id}}" class="btn btn-warning" >cancel Rent</a>
                            </ul>
                        @endif
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <p>
                        ...
                        <a href="https://www.phpjabbers.com/">Mehri Chaima</a>
                    </p>
                </div>
            </div>
        </div>
